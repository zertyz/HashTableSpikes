...
//		"}	// namespace ConstexprRandomUniqueKeys");
	...
	generateRandomFile<4'096'000>("ConstexprRandomUniqueKeys.cpp",
		"// this file was generated by 'GenerateConstExprData.cpp'\n"
		"\n"
		"#include <array>\n"
		"#include <string>\n"
		"\n"
		"static constexpr unsigned _keysLength = 4'096'000;\n"
		"\n"
		"static constexpr std::array<std::string_view, _keysLength> _keys = {",
		[] (ofstream& outfile, unsigned i, const char* key) { outfile << "\"" << key << "\""; },
		"\n};	// _keys \n"
		"\n"
		"struct ConstexprRandomUniqueKeys {\n"
		"\n"
		"	static const unsigned keysLength;\n"
		"	static const std::array<std::string_view, _keysLength> keys;"
		"\n"
		"};\n"
		"const unsigned                                  ConstexprRandomUniqueKeys::keysLength = _keysLength;\n"
		"const std::array<std::string_view, _keysLength> ConstexprRandomUniqueKeys::keys       = _keys;\n");
